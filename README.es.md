...
- Tu IA dice "Claro, lo arreglo" antes de arreglarlo. Ese turno de narración: **$0.017 desperdiciado.** Datos reales de 428 sesiones: **$1.03/sesión perdidos.**
- Tu conversación llega a 74 turnos en vez de dividirse en 20. Coste extra de releer todo ese historial: **$0.46 desperdiciado.**
- `git add`, luego `git commit`, luego `git push` — tres turnos en lugar de un comando encadenado: **$0.044 desperdiciado.**
...
```
                          ANTES          AHORA          CAMBIO
Turnos medios/sesión      73.9           21.1           -52.8
Ventana de context media  65.6K          33.7K          -49%
Turnos con desperdicio    73.7%          8.0%           -65.7%

Coste medio/sesión        $3.07          $0.46          -$2.61
Gasto mensual             $2,816         $422           -$2,394
```
...
Aún no he medido completamente el valor en dólares de Codex, pero en el tier de $20, Codex Plus entrega aproximadamente **3x el uso de código** de Claude Pro.

Por qué: las conversaciones de ChatGPT — incluyendo GPT-5.4 Extended Thinking y deep research — no cuentan contra tu cuota de Codex. Solo el coding ya es 3x Claude Pro, y el chat Pro viene gratis encima.

**Si no planeas comprar al menos el tier de Claude de $100, compra $20 Codex Plus.** 3x el uso de código de Claude Pro, más GPT-5.4 Extended Thinking y deep research gratis.
...
| Coste de turno en mitad de sesión | $0.017 |
| Total de sesión eficiente | $0.41 |
...
**El desperdicio.** Cada turno de narración cuesta **$0.017** (relectura del context + ~500 tokens de texto de estado). Datos reales de 428 sesiones: **$1.03/sesión — 30% de todo el desperdicio**. Con 10 sesiones/día: **$10.30/día ($309/mes)** solo en narración.

**La corrección.** vibecheck añade: *"Ningún turno sin llamada a herramienta. Nada de narración. Piensa y actúa en el mismo turno."* Elimina la narración por completo. **Ahorra ~$0.88/sesión.**
...
**El desperdicio.** Una sesión de 40 turnos: **$0.70.** Dos sesiones de 20 turnos (mismo trabajo): **$0.60.** La diferencia — **$0.10** — no compra nada. A 100 turnos: una sesión cuesta **$2.53** frente a cuatro sesiones de 25 turnos a **$1.64.** Son **$0.89 desperdiciados** por no dividir la sesión. Datos reales de 428 sesiones: **$0.46/sesión — 13%**.

**La corrección.** Enseña: *"Usa /clear o /compact entre tareas no relacionadas. Empieza conversaciones nuevas."* **Ahorra ~$0.37/sesión.**
...
**El desperdicio.** Tres ciclos fallidos: 6 turnos extra ($0.102) + 12K tokens de errores muertos ($0.036 de impuesto por context). **Total: ~$0.14 por episodio.** Frecuencia ~10%. **Ponderado: $0.015/sesión.**

**La corrección.** Añade: *"Tras 2 intentos fallidos en el mismo archivo: para, relee el error completo, piensa, aplica una corrección concreta."* **Ahorra ~$0.01/sesión.**
...
**El desperdicio.** 5K tokens x 12 turnos restantes x $0.30/1M = **$0.018/instancia** de impuesto por context. Ocurre 2-3 veces/sesión. Sin caching: **$0.180/instancia** — 10x peor. Datos reales: **$1.05/sesión** — 31% del desperdicio.

**La corrección.** Añade: *"Redirige la salida de compilación/test a /tmp/, usa flags --quiet, máximo tail -50."* **Ahorra ~$0.89/sesión.**
...
**El desperdicio.** Cada separación: **$0.010.** Las sesiones típicas tienen 3-4 separaciones. Datos reales: **$0.14/sesión**.

**La corrección.** Añade: *"Encadena comandos con `&&` cuando sea seguro."* **Ahorra ~$0.11/sesión.**
...
**El desperdicio.** Cinco lecturas innecesarias: $0.085 en turnos + $0.027 de impuesto por context = **$0.112/episodio.** Ocurre en ~25% de las sesiones. **Ponderado: $0.09/sesión.**

**La corrección.** Fomenta la búsqueda dirigida (grep/glob primero), agrupando múltiples lecturas por turno. **Ahorra ~$0.07/sesión.**
...
**El desperdicio.** 2 turnos extra x $0.017 = **$0.034/instancia.** Ocurre en ~60% de las sesiones. **Ponderado: $0.058/sesión.**

**La corrección.** Añade: *"Agrupa llamadas a herramientas independientes (múltiples lecturas/ediciones por turno)."* **Ahorra ~$0.05/sesión.**
...
**El desperdicio.** 1 turno desperdiciado + contenido duplicado = **$0.019/relectura.** 1-2 por sesión. **Ponderado: $0.066/sesión.**

**La corrección.** Añade: *"El contenido está en el context tras la primera lectura. Relee solo si el archivo ha cambiado."* **Ahorra ~$0.05/sesión.**

#### 9. Bucles de espera y sondeo

**Qué es.** `sleep 5 && check_status`, repetido 3-5 veces. Cada sondeo relee el context completo.

**El desperdicio.** 4 sondeos x $0.017 = **$0.068/episodio.** Ocurre en ~20% de las sesiones. **Ponderado: $0.043/sesión.**

**La corrección.** Añade: *"Usa flags --wait o run_in_background."* **Ahorra ~$0.034/sesión.**
...
**El desperdicio.** **$0.019/reintento.** Ocurre en ~30% de las sesiones. **Ponderado: $0.080/sesión.**
...
**El desperdicio.** **$0.023/búsqueda.** Ocurre en ~40% de las sesiones. **Ponderado: $0.023/sesión.**
...
**El desperdicio.** 3 turnos extra + salida de git = **$0.044/instancia.** Ocurre en ~70% de las sesiones. **Ponderado: $0.003/sesión.**

**La corrección.** Añade: *"Encadena comandos de git con `&&`."* **Ahorra ~$0.003/sesión.**
...
Un archivo de 10K tokens comprimido a 6K ahorra $0.044/sesión. Con 10 sesiones/día: **$0.44/día ($13/mes).**
...
| 2 | Podredumbre de context | $0.46 | $0.37 |
| 3 | Depuración ping-pong | $0.015 | $0.01 |
| 4 | Salida verbosa | $1.05 | $0.89 |
| 5 | Comandos no encadenados | $0.14 | $0.11 |
| 6 | Vagabundeo por el código | $0.09 | $0.07 |
| 7 | Ediciones no agrupadas | $0.058 | $0.05 |
| 8 | Relecturas de archivos | $0.066 | $0.05 |
| 9 | Bucles de espera/sondeo | $0.043 | $0.034 |
| 10 | Reintentos fallidos | $0.08 | $0.06 |
| 11 | Búsquedas de esquema | $0.023 | $0.02 |
| 12 | Ceremonia de git | $0.003 | $0.003 |
| + | Compresión | $0.044 | $0.044 |
| + | Supresión de salida | $0.047 | $0.038 |
| | **Total** | **$3.15*** | **$2.61** |

*Los patrones individuales pueden superponerse en el mismo turno — los totales reflejan medición por patrón. Ahorro real agregado: $3.07 → $0.46 (ver línea final).

**Sesión típica con desperdicio: $3.07. Tras vibecheck: $0.46. Ahorro: 85%.**

- **Poco desperdicio** (sesiones cortas, pocos patrones): 40-55%
- **Desperdicio moderado** (usuario promedio): 55-70%
- **Mucho desperdicio** (sesiones largas, múltiples patrones): 70-85%
...
- **95% de tasa de cache hit** — típico en sesiones de programación rápida. Las sesiones más lentas tendrán costes más altos.
...
- **600 tokens/turno de crecimiento** — las sesiones verbosas pueden llegar a 1,000-2,000.
- **Tarifa efectiva de entrada: $0.435/1M** — combinación del 95% con cache ($0.30) + 5% sin cache ($3.00).
