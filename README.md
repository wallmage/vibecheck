...
vibecheck is a **skill** — think of it like a cheat sheet your AI reads. No software, no downloads. You paste one message, your AI learns the skill, done.
...
Your data doesn't leave your machine. There's no server. The code is a handful of Python scripts that read local files and print results to your screen. Open source — read it yourself.
...
Run it once, get projections. Run it again in a couple weeks, see what actually changed:
...
1. Idle narration — "Now I'll fix that" → just fix it
2. Context rot — 60-message conversations where the last message costs 60x the first
3. Ping-pong debugging — edit, break, edit, break, edit, break
